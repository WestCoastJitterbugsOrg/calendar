  ...
  return (
    <input
      ...
      className={`appearance-none w-5 h-5 bg-wcj-sand border-wcj-black border-solid border-[2px] rounded-md
                  ...
                  checked:after:opacity-100 checked:after:left-2 checked:after:-top-[3px] checked:after:w-2 checked:after:h-[18px] checked:after:rotate-[50deg] checked:after:border-solid 
